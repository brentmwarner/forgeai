...
export const WebsiteDetails = (): JSX.Element => {
    ...
    <div className="bg-white flex flex-col items-center min-h-screen w-full">
      ...
      <main className="flex flex-col items-center gap-10 w-full max-w-[672px] mt-[88px]">
        ...
        <div className="flex flex-col gap-6 w-full">
          <section className="flex flex-col items-start gap-6 w-full p-6 bg-neutral-50 rounded-2xl">
            <div>
            ...
            <div className="flex flex-col gap-6 w-full">
              <div className="flex flex-col gap-2">
                <label htmlFor="siteName" className="text-sm font-medium text-stone-950">
                  Site Name
                </label>
                <input
                  id="siteName"
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="figmaUrl" className="text-sm font-medium text-stone-950">
                  Import from Figma (Optional)
                </label>
                <input
                  id="figmaUrl"
                  type="text"
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-neutral-200 focus:outline-none focus:ring-2 focus:ring-stone-950"
                  placeholder="http://figma.com/file/..."
                />
              </div>
            </div>
          </section>
          ...
          <div className="flex justify-end gap-3 w-full">
            ...
            <button
              onClick={handleNext}
              className="px-4 py-2 rounded-lg bg-stone-950 text-white hover:bg-stone-800"
            >
              Next
            </button>
          </div>
