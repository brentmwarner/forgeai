...
import { Pencil, Sparkles, ArrowUp, Image, Smile } from "lucide-react";
...
export const Onboarding = (): JSX.Element => {
  ...
  return (
    <div className="bg-white flex flex-col items-center min-h-screen w-full">
      ...
      <main className="flex flex-col justify-between min-h-[calc(100vh-56px-4.5rem)] w-full max-w-[672px] px-4">
        <div className="flex flex-col gap-10 mt-[88px]">
          ...
          <div className="grid grid-cols-2 gap-4">
            {mainCards.map((card, index) => (
              <button
                key={index}
                className="flex flex-col items-start gap-6 p-8 rounded-2xl bg-neutral-50 hover:bg-neutral-100 transition-colors text-left"
              >
                {card.icon}
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-sm leading-6 font-normal text-neutral-500">
                    {card.description}
                  </p>
                </div>
              </button>
        ...
        <div className="mb-6">
          <div className="relative w-full bg-neutral-50 flex items-center transition-all duration-200"
               style={{
            ...
            <div className="w-full">
              <textarea
                ...
                className="w-full bg-transparent border-none resize-none focus:outline-none focus:ring-0 text-sm placeholder:text-neutral-500 min-h-[44px] pr-[160px] scrollbar-thin scrollbar-track-none scrollbar-thumb-neutral-200"
                style={{
                  height: '44px',
                  maxHeight: '400px',
                  paddingLeft: '16px',
            ...
            <div className="absolute right-1.5 bottom-0 flex items-center gap-8 px-2 h-[44px]">
              ...
              <button className="w-10 h-10 bg-brand-500 hover:bg-brand-600 rounded-full flex items-center justify-center transition-colors">
