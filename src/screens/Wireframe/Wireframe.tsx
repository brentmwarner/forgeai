...
import { ArrowUpIcon, FigmaIcon, ImageIcon } from "lucide-react";
...
export const Wireframe = (): JSX.Element => {
  ...
  return (
    <div className="bg-white flex flex-col items-center min-h-screen w-full">
      ...
      <main className="flex flex-col items-center gap-10 w-full max-w-[672px] mt-[88px]">
        <section className="flex flex-col items-center gap-2 w-full">
          <h1 className="font-text-4xl-leading-none-medium font-[number:var(--text-4xl-leading-none-medium-font-weight)] text-black text-[length:var(--text-4xl-leading-none-medium-font-size)] text-center tracking-[var(--text-4xl-leading-none-medium-letter-spacing)] leading-[var(--text-4xl-leading-none-medium-line-height)] [font-style:var(--text-4xl-leading-none-medium-font-style)]">
            Good Afternoon, Brent
          </h1>

          <p className="font-text-base-leading-7-normal font-[number:var(--text-base-leading-7-normal-font-weight)] text-black text-[length:var(--text-base-leading-7-normal-font-size)] text-center tracking-[var(--text-base-leading-7-normal-letter-spacing)] leading-[var(--text-base-leading-7-normal-line-height)] [font-style:var(--text-base-leading-7-normal-font-style)]">
        ...
        <section className="flex flex-col items-start gap-4 w-full">
          <Card className="w-full border-none shadow-none">
            <CardContent className="flex h-[200px] items-start gap-2 p-3 relative w-full bg-neutral-100 rounded-2xl overflow-hidden border-none ring-0">
              <Textarea
                placeholder="Ask forge to build something..."
                className="w-full h-full resize-none border-none bg-transparent p-0 font-text-sm-leading-5-normal font-[number:var(--text-sm-leading-5-normal-font-weight)] text-black text-[length:var(--text-sm-leading-5-normal-font-size)] tracking-[var(--text-sm-leading-5-normal-letter-spacing)] leading-[var(--text-sm-leading-5-normal-line-height)] [font-style:var(--text-sm-leading-5-normal-font-style)] focus:outline-none focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0"
              />
              <Button
                size="icon"
                className="absolute bottom-3 right-3 bg-stone-900 rounded-full w-10 h-10 p-0"
              >
          ...
          <div className="flex items-start gap-3 w-full">
            {actionButtons.map((button, index) => (
              <Button
                key={index}
                variant="outline"
                className="flex items-center gap-1 px-2 py-1.5 rounded-full border border-solid border-slate-200"
              >
                {button.icon}
                <span className="font-text-sm-leading-6-medium font-[number:var(--text-sm-leading-6-medium-font-weight)] text-slate-900 text-[length:var(--text-sm-leading-6-medium-font-size)] tracking-[var(--text-sm-leading-6-medium-letter-spacing)] leading-[var(--text-sm-leading-6-medium-line-height)] [font-style:var(--text-sm-leading-6-medium-font-style)]">
                  {button.label}
                </span>
              </Button>
            ))}
