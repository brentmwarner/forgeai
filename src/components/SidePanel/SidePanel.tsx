...
import { PanelLeft, Settings, CreditCard, HelpCircle, LogOut, ChevronRight, Monitor, Sun, Moon } from "lucide-react";
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "bg-white/80 dark:bg-neutral-800/55 shadow-lg rounded-tr-2xl backdrop-blur-md",
    ...
    >
      <div className="flex flex-col gap-4 w-full">
        <div className="flex justify-between items-center">
          ...
          <button
            onClick={onPinClick}
            className={cn(
              "p-2 hover:bg-neutral-100/50 dark:hover:bg-white/5 rounded-lg transition-colors",
              isPanelPinned && "bg-neutral-100/50 dark:bg-white/5"
            )}
          >
      ...
      <DropdownMenu.Root>
        <DropdownMenu.Trigger asChild>
          <div className="flex items-center gap-3 w-full p-2 mb-4 rounded-lg hover:bg-neutral-100/50 dark:hover:bg-white/5 transition-colors cursor-pointer">
            <div className="w-8 h-8 rounded-full bg-stone-950 dark:bg-white flex items-center justify-center">
              <span className="text-white dark:text-stone-950 text-sm font-medium">BW</span>
            </div>
            <div className="flex flex-col">
              <span className="text-sm font-medium text-stone-950 dark:text-white">Brent</span>
              <span className="text-xs text-stone-500 dark:text-neutral-400">email@example.com</span>
            </div>
          </div>
            ...
            <DropdownMenu.Sub>
              ...
              <DropdownMenu.Portal>
                <DropdownMenu.SubContent
                  className="w-[200px] bg-white dark:bg-neutral-800 rounded-lg shadow-lg p-2"
                  sideOffset={-4}
                  alignOffset={-4}
                  style={{ zIndex: 10001 }}
                >
                  <DropdownMenu.Item
                    className="flex items-center gap-2 px-3 py-2 text-sm text-stone-950 dark:text-white outline-none cursor-pointer rounded hover:bg-neutral-100/50 dark:hover:bg-white/5"
